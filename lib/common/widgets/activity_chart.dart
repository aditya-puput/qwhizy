...
class _LineChart extends StatelessWidget {
  ...
  const _LineChart({required this.isShowingMainData, required this.colors});
  ...
  FlGridData get gridData => FlGridData(show: true, horizontalInterval: 1.0, drawVerticalLine: false, getDrawingHorizontalLine:(value) => const FlLine(
          color: Color(0xFF3CEAC1), 
          strokeWidth: 1, 
        )
  );
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Padding(
                  ...
                  child: _LineChart(isShowingMainData: isShowingMainData, colors: const [Color(0xFFFFC700), Color(0xFF74B5ED), Color(0xFFD764D2)],),
                ),
              ),
              const SizedBox(
                height: 10,
