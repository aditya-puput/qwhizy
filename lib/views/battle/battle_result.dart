...
class BattleResult extends StatefulWidget {
  ...
  const BattleResult({super.key, required this.battle, required this.endTime});
...
class _BattleResultState extends State<BattleResult> {
  ...
  void initState() {
    ...
    widget.battle.questions.asMap().forEach((index, question) {
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(
                                        '${(benar / widget.battle.questions.length * 100).toStringAsFixed(0)}%',
                                        style: AppFontStyle.boldText.copyWith(
                                            ...
                                            height: .8)),
                                    Text(
                                        '$benar/${widget.battle.questions.length}',
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text('${widget.battle.questions.length - benar}',
                                        style: AppFontStyle.boldText.copyWith(
                                            color: darkMode
                                                ? Colors.white
                                                : Colors.black,
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          answers = List.generate(
                              widget.battle.questions.length, (index) => null);
