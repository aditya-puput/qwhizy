...
import 'package:mdaq/views/battle/battle_result.dart';
...
class BattleQuiz extends StatefulWidget {
  ...
  final bool review;
  const BattleQuiz(
      {super.key, required this.id, required this.battle, this.review = false});

  @override
  State<BattleQuiz> createState() => _BattleQuizState();
}
...
class _BattleQuizState extends State<BattleQuiz> {
  ...
  Widget build(BuildContext context) {
    final begin = widget.battle.questions[widget.id].begin;
    final end = widget.battle.questions[widget.id].end;
        ...
        child: Stack(
          ...
          children: [
            Column(
              children: [
                QuizTopBar(
                  title: widget.review ? 'Ulas Soal' : widget.battle.title,
                  subTitle: widget.review ? widget.battle.title : '',
                  topBar: false,
                  content: Expanded(
                    child: Container(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Center(
                                  child: Text(
                                      widget.battle.questions[widget.id].title,
                        ...
                        Expanded(
                          child: SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: widget
                                  .battle.questions[widget.id].answers.length,
                              itemBuilder: (BuildContext context, int i) {
                                final item = widget
                                    .battle.questions[widget.id].answers[i];
                                    ...
                                    decoration: BoxDecoration(
                                      color: widget.review &&
                                          ...
                                          : darkMode
                                              ...
                                              : const Color(0xFFE7EEF8),
                                      gradient: answer == i && !widget.review ||
                                              widget.review &&
                                                  answer == i &&
                                                  answer ==
                                                      widget
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  if (widget.id <
                                      widget.battle.questions.length - 1) {
                                    Navigator.of(context)
                                        .pushReplacement(TransitionFade(
                                            child: BattleQuiz(
                                      id: widget.id + 1,
